...
public class EscrituraArchivoConstructora {
    ...
    public void establecerListaConstructora() {
        LecturaArchivoConstructora co1 = new LecturaArchivoConstructora(obtenerNombreArchivo());
        co1.establecerListaConstructora();
        listaConstructora = co1.obtenerListaConstructora();
    }
