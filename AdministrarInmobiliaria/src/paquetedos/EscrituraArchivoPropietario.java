...
public class EscrituraArchivoPropietario {
    ...
    public void establecerListaPropietarios() {
        LecturaArchivoPropietario p1 = new LecturaArchivoPropietario(obtenerNombreArchivo());
        p1.establecerListaPropietarios();
        listaPropietarios = p1.obtenerListaPropietarios();
    }
